...
namespace JanusApi
{
  ...
  //public class JanusVideoRoomResponse : JanusResponse
  //{
  //  public JanusVideoRoomPluginData plugindata { get; set; } 
  //}

  //  public class JanusVideoRoomJoinResponse : JanusResponse
  //  {
  //      public JanusVideoRoomJoinPluginData plugindata { get; set; }
  //  }

  //  public class JanusVideoRoomInfoResponse : JanusResponse
  //{
  //  public JanusVideoRoomInfoPluginData plugindata { get; set; }
  //}

  //public class JanusVideoRoomListResponse : JanusResponse
  //{
  //  public JanusVideoRoomListPluginData plugindata { get; set; }
  //}

  //public class JanusVideoRoomExistsResponse : JanusResponse
  //{
  //  public JanusVideoRoomExistsPluginData plugindata { get; set; }
  //}

  public class JanusVideoRoomPluginData : PluginResponse
    {
    public JanusVideoRoomPluginDataInternal data { get; set; }
  }

    public class JanusVideoRoomJoinPluginData : PluginResponse
    {
        public JanusVideoRoomJoinPluginDataInternal data { get; set; }
    }

    public class JanusVideoRoomExistsPluginData : PluginResponse
    {
    public JanusVideoRoomExistsPluginDataInternal data { get; set; }
  }

  public class JanusVideoRoomListPluginData : PluginResponse
    {
    public JanusVideoRoomListPluginDataInternal data { get; set; }
  }

  public class JanusVideoRoomInfoPluginData : PluginResponse
    {
  ...
  public class JanusVideoRoomPluginDataInternal
  {
    ...
    public class Publisher
    {
        ...
        public List<JanusStream> streams { get; set; }
        public bool talking { get; set; }
    }
    ...
    public class JanusVideoRoomJoinPluginDataInternal
    {
        public string videoroom { get; set; }
        public int room { get; set; }
        public string description { get; set; }
